<x-app-layout>
    <x-slot name="title">Riwayat Deposit</x-slot>
    ...
    <div class="relative w-full">
        ...
        <input type="text" id="search-input" placeholder="Cari iuran..." 
    ...
    <!-- DEPOSIT LIST -->
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden divide-y divide-gray-50" id="deposit-list">
        @include('deposits.partials.list')
    </div>

    <!-- INFINITE SCROLL SENTINEL -->
    <div id="sentinel" class="py-8 flex justify-center @if(!$deposits->hasMorePages()) hidden @endif">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            let nextPageUrl = "{{ $deposits->nextPageUrl() }}";
